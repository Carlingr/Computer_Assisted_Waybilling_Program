...
SELECT rawTbl.ID, rawTbl.Origin, rawTbl.OriginTown, rawTbl.OriginColor, rawTbl.OriginDistrict, rawTbl.destination, rawTbl.destinationTown, rawTbl.destinationColor, rawTbl.destinationDistrict, rawTbl.CarType, FLOOR(RAND()*(rawTbl.MaxQty-rawTbl.MinQty)+rawTbl.MinQty) AS Qty, rawTbl.Milepost  -- calculate random qty
FROM ( -- add destination district color
    SELECT rawTbl.ID, rawTbl.Origin, rawTbl.OriginTown, rawTbl.OriginColor, rawTbl.OriginDistrict, rawTbl.destination, towns.Color AS destinationTown, rawTbl.destinationColor, rawTbl.destinationDistrict, rawTbl.CarType, rawTbl.Milepost, rawTbl.MinQty, rawTbl.MaxQty
